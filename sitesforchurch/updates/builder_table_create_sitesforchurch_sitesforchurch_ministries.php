...
class BuilderTableCreateSitesforchurchSitesforchurchMinistries extends Migration
{
    public function up()
    {
        Schema::create('sitesforchurch_sitesforchurch_ministries', function($table)
        {
            $table->engine = 'InnoDB';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sitesforchurch_sitesforchurch_ministries');
    }
}
